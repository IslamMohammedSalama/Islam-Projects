...
# Function to stop recording and add audio to the video
def stop_recording():
    ...
    if is_recording:
        ...
        audio_clip = AudioFileClip('path_to_audio_file.mp3')  # Replace 'path_to_audio_file.mp3' with the actual path to your audio file
        video_clip = video_clip.set_audio(audio_clip)
        video_clip.write_videofile('output_with_audio.mp4', codec="libx264", audio_codec="aac")
        os.remove('output.avi')  # Remove the original video file
...
imagel = Image.open('/home/shared/Islam-projects/Python/gui_apps/camera/pngegg.png')  # Update this path to the image you want to use
